...
\title{Perbandingan Metode Rule-Based dan Decision Tree C4.5 untuk Penentuan Prioritas Pengiriman Invoice}\let\Title\@title   %Judul dalam bahasa Indonesia

\newcommand{\EngTitle}{Comparison of Rule-Based and Decision Tree C4.5 Methods for Invoice Delivery Priority Determination}  %Judul dalam bahasa Inggris
