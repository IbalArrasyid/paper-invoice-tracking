...
\title{Formalisasi Pengetahuan Operasional untuk Rekomendasi Prioritas pada Sistem Pelacakan Invoice dan Proof of Delivery}\let\Title\@title   %Judul dalam bahasa Indonesia

\newcommand{\EngTitle}{Operational Knowledge Formalization for Priority Recommendation in an Invoice Tracking and Proof of Delivery System}  %Judul dalam bahasa Inggris

\author{Farah Annisa}  \let\Author\@author  %Nama mhs
\newcommand{\NIM}{1304221025} %Jangan lupa hapus tanda ( dan )
