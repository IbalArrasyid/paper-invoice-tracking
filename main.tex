...
\title{Analisis Komparatif Metode Rule-Based dan Decision Tree untuk Klasifikasi Prioritas Pengiriman Invoice}\let\Title\@title   %Judul dalam bahasa Indonesia

\newcommand{\EngTitle}{Comparative Analysis of Rule-Based and Decision Tree Methods for Invoice Delivery Priority Classification}  %Judul dalam bahasa Inggris
